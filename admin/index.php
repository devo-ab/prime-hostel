			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						<h1 class="text-center text-bold text-light mt-4x">Prime Hostel</h1>
				...
				<!-- <div style="display: flex; justify-content: space-around; text-align: center; margin-top: 25px; background-color: darkgrey; padding: 6px;">
					<div>
						<h3>Prime Hostel</h3>
						<p> 2024 Prime Hostel. All rights reserved.</p>
					</div>
